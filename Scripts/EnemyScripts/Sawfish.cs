...
public class Sawfish : MonoBehaviour
{
    ...
    private float attackLerpScale = 0.0075f;

    private float orbitRadius = 3500f;   // Desired radius of the circular path
    private float orbitSpeed = 50f; // Speed of orbiting
    ...
    private int side = -1;
    private float lerpScale = 0.0025f;
    ...
    void Start()
    {
        ...
        if (pfc == null)
        {
            UnityEngine.Debug.LogError("SAWFISH could not find Pufferfish");
        }
        else
        {
